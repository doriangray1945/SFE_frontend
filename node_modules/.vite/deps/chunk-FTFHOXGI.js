...
var NavbarBrand = React4.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React10.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React11.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  return (0, import_jsx_runtime6.jsx)(Component, {
    ...
    children: children || (0, import_jsx_runtime6.jsx)("span", {
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react14.useState)(() => mql ? mql.matches : false);
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react15.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
function useUpdatedRef(value) {
  const valueRef = (0, import_react17.useRef)(value);
...
function useWillUnmount(fn) {
  ...
  (0, import_react18.useEffect)(() => () => onUnmount.current(), []);
}
...
var Context = (0, import_react20.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react20.useContext)(Context);
}
...
function useWaitForDOMRef(ref, onResolved) {
  ...
  const [resolvedRef, setRef] = (0, import_react21.useState)(() => resolveContainerRef(ref, window2 == null ? void 0 : window2.document));
  if (!resolvedRef) {
...
function NoopTransition({
  ...
  const hasEnteredRef = (0, import_react22.useRef)(inProp);
  ...
  const child = (0, import_react22.cloneElement)(children, {
    ref: combinedRef
  });
...
function getReactVersion() {
  const parts = React12.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
function useRTGTransitionProps(_ref) {
  ...
  return Object.assign({}, props, {
    ...
    ) : (0, import_react23.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React13.forwardRef((_ref, ref) => {
  let {
    component: Component
  } = _ref, props = _objectWithoutPropertiesLoose3(_ref, _excluded2);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime7.jsx)(Component, Object.assign({
    ref
  }, transitionProps));
});
...
function ImperativeTransition({
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react24.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime8.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime8.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime8.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react25.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime9.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime9.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, {
...
var OffcanvasBody = React17.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var OffcanvasToggling = React18.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
...
var ModalContext = React19.createContext({
...
var AbstractModalHeader = React21.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var OffcanvasHeader = React22.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var divWithClassName_default = (className) => React23.forwardRef((p, ref) => (0, import_jsx_runtime17.jsx)("div", {
  ...p,
  ref,
...
var OffcanvasTitle = React24.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React25.forwardRef(({
  bsPrefix,
  className,
  children,
  ...
  const renderBackdrop = (0, import_react28.useCallback)((backdropProps) => (0, import_jsx_runtime19.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React26.forwardRef(({
  onHide,
  ...props
}, ref) => {
  const context2 = (0, import_react29.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
...
var NavbarText = React27.forwardRef(({
  className,
  bsPrefix,
  as: Component = "span",
  ...props
...
var Navbar = React28.forwardRef((props, ref) => {
  const {
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-FTFHOXGI.js.map
